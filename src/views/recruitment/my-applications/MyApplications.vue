  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: 'post', label: 'Designation', sortable: true },
      ...
      /* eslint-disable global-require */
      status: [{
        1: 'Pending Review', 2: 'Under Review', 3: 'Rejected', 4: 'Short Listed', 5: 'Successful',
      },
      {
        1: 'light-warning', 2: 'warning', 3: 'light-danger', 4: 'light-warning', 5: 'success',
      }],
      codeKitchenSink,
    }
  },
